                ...
                <tbody class="divide-y divide-slate-50">
                    @forelse($events as $event)
                        <tr class="hover:bg-slate-50/50 transition-colors">
                            ...
                            <td class="px-6 py-4">
                                <span
                                    class="px-2.5 py-1 {{ $event->status === 'published' ? 'bg-green-50 text-green-600' : 'bg-slate-100 text-slate-500' }} text-[10px] font-extrabold uppercase rounded-full tracking-wider">
